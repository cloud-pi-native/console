    ...
    describe('getServices', () => {
        it('should return services for authorized user', async () => {
            ...
            const response = await app
                .inject()
                .get(
                    projectServiceContract.getServices.path.replace(
                        ':projectId',
                        projectId,
                    ),
                )
            ...
            expect(businessGetServicesMock).toHaveBeenCalledWith(
                projectId,
                'user',
            );
    ...
    describe('updateProjectServices', () => {
        ...
        it('should update services for project manager', async () => {
            ...
            const response = await app
                .inject()
                .post(
                    projectServiceContract.updateProjectServices.path.replace(
                        ':projectId',
                        projectId,
                    ),
                )
            ...
            expect(businessUpdateServicesMock).toHaveBeenCalledWith(
                projectId,
                updateData,
                ['user'],
            );
