    ...
    describe('listMembers', () => {
        it('should return members for authorized user', async () => {
            ...
            const response = await app
                .inject()
                .get(
                    projectMemberContract.listMembers.path.replace(
                        ':projectId',
                        projectId,
                    ),
                )
    ...
    describe('addMember', () => {
        ...
        it('should add member for authorized user', async () => {
            ...
            const response = await app
                .inject()
                .post(
                    projectMemberContract.addMember.path.replace(
                        ':projectId',
                        projectId,
                    ),
                )
        ...
        it('should pass business error', async () => {
            ...
            const user = getUserMockInfos(false, undefined, projectPerms);
            authUserMock.mockResolvedValueOnce(user);
            businessAddMemberMock.mockResolvedValueOnce(
    ...
    describe('patchMembers', () => {
        ...
        it('should patch members for authorized user', async () => {
            ...
            const response = await app
                .inject()
                .patch(
                    projectMemberContract.patchMembers.path.replace(
                        ':projectId',
                        projectId,
                    ),
                )
    ...
    describe('removeMember', () => {
        it('should remove member for authorized user', async () => {
            ...
            const response = await app
                .inject()
                .delete(
                    projectMemberContract.removeMember.path
