    ...
    describe('getStageEnvironments', () => {
        it('should return stage environments for admin', async () => {
            ...
            const response = await app
                .inject()
                .get(
                    stageContract.getStageEnvironments.path.replace(
                        ':stageId',
                        faker.string.uuid(),
                    ),
                )
        ...
        it('should pass business error', async () => {
            ...
            businessGetEnvironmentsMock.mockResolvedValueOnce(
    ...
    describe('updateStage', () => {
        ...
        it('should update and return stage for admin', async () => {
            ...
            const response = await app
                .inject()
                .put(
                    stageContract.updateStage.path.replace(':stageId', stageId),
                )
                .body(stage)
                .end();
    ...
    describe('deleteStage', () => {
        it('should delete stage for admin', async () => {
            ...
            const response = await app
                .inject()
                .delete(
                    stageContract.deleteStage.path.replace(
                        ':stageId',
                        faker.string.uuid(),
                    ),
                )
