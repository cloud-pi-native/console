...
const businessGetServiceChainDetailsMock = vi.spyOn(
    business,
    'getServiceChainDetails',
);
const businessRetryServiceChainMock = vi.spyOn(business, 'retryServiceChain');
const businessValidateServiceChainMock = vi.spyOn(
    business,
    'validateServiceChain',
);
const businessGetServiceChainsFlowsMock = vi.spyOn(
    business,
...
describe('test ServiceChainContract', () => {
    ...
    describe('getServiceChainDetails', () => {
        it('should return serviceChain details', async () => {
            ...
            businessGetServiceChainDetailsMock.mockResolvedValueOnce(
                serviceChainDetails,
            );
            const response = await app
                .inject()
    ...
    describe('getServiceChainFlows', () => {
        it('should return serviceChain flows', async () => {
            ...
            businessGetServiceChainsFlowsMock.mockResolvedValueOnce(
                serviceChainFlows,
            );
            const response = await app
                .inject()
