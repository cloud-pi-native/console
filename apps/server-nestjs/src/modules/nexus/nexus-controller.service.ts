...
export class NexusControllerService {
  ...
  private async createMavenRepos(projectSlug: string, options: { snapshotWritePolicy: string, releaseWritePolicy: string }) {
    ...
    await Promise.all([
      this.upsertRepo({
        ...
        create: () => this.client.createRepositoriesMavenHosted({
        ...
        update: () => this.client.updateRepositoriesMavenHosted(names.hosted[0].repo, {
          name: names.hosted[0].repo,
          online: true,
          storage: {
            blobStoreName: 'default',
      ...
      this.upsertRepo({
        ...
        update: () => this.client.updateRepositoriesMavenHosted(names.hosted[1].repo, {
          name: names.hosted[1].repo,
          online: true,
          storage: {
            blobStoreName: 'default',
  ...
  private async createNpmRepos(projectSlug: string, writePolicy: string) {
    ...
    await this.upsertRepo({
      ...
      create: () => this.client.createRepositoriesNpmHosted({
        name: names.hosted[0].repo,
        online: true,
        storage: {
          blobStoreName: 'default',
      ...
      update: () => this.client.updateRepositoriesNpmHosted(names.hosted[0].repo, {
        name: names.hosted[0].repo,
        online: true,
        storage: {
          blobStoreName: 'default',
