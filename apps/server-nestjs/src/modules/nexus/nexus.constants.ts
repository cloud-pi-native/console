...
export const DEFAULT_PLATFORM_READER_GROUP_PATHS = '/console/reader,/console/security'
...
export const DEFAULT_PROJECT_READER_GROUP_PATH_SUFFIXES = '/console/reader,/console/security,/console/developer'
...
export const PLATFORM_READER_GROUP_PATHS_PLUGIN_KEY = 'platformReaderGroupPaths'
...
export const PROJECT_READER_GROUP_PATH_SUFFIXES_PLUGIN_KEY = 'projectReaderGroupPathSuffixes'
