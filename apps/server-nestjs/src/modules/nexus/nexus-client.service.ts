...
export class NexusClientService {
  ...
  @StartActiveSpan()
  async postRepositoriesMavenHosted(body: NexusMavenHostedRepositoryUpsertRequest): Promise<void> {
    await this.fetch('/repositories/maven/hosted', { method: 'POST', body })
  }

  @StartActiveSpan()
  async putRepositoriesMavenHosted(name: string, body: NexusMavenHostedRepositoryUpsertRequest): Promise<void> {
    await this.fetch(`/repositories/maven/hosted/${name}`, { method: 'PUT', body })
  }

  @StartActiveSpan()
  async postRepositoriesMavenGroup(body: NexusMavenGroupRepositoryUpsertRequest): Promise<void> {
  ...
  @StartActiveSpan()
  async postRepositoriesNpmHosted(body: NexusNpmHostedRepositoryUpsertRequest): Promise<void> {
    await this.fetch('/repositories/npm/hosted', { method: 'POST', body })
  }

  @StartActiveSpan()
  async putRepositoriesNpmHosted(name: string, body: NexusNpmHostedRepositoryUpsertRequest): Promise<void> {
  ...
  @StartActiveSpan()
  async postSecurityPrivilegesRepositoryView(body: NexusRepositoryViewPrivilegeUpsertRequest): Promise<void> {
    await this.fetch('/security/privileges/repository-view', { method: 'POST', body })
  }

  @StartActiveSpan()
  async putSecurityPrivilegesRepositoryView(name: string, body: NexusRepositoryViewPrivilegeUpsertRequest): Promise<void> {
  ...
  @StartActiveSpan()
  async postSecurityRoles(body: NexusRoleCreateRequest): Promise<void> {
    await this.fetch('/security/roles', { method: 'POST', body })
  }

  @StartActiveSpan()
  async putSecurityRoles(id: string, body: NexusRoleUpdateRequest): Promise<void> {
