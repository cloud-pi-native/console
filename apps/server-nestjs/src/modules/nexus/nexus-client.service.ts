...
export class NexusClientService {
  ...
  async getRepositoriesMavenHosted(name: string) {
    try {
      const res = await this.fetch(`/repositories/maven/hosted/${name}`)
      return res.data
    } catch (error) {
  ...
  async getRepositoriesMavenGroup(name: string) {
    try {
      const res = await this.fetch(`/repositories/maven/group/${name}`)
      return res.data
    } catch (error) {
      if (error instanceof NexusError && error.status === 404) return null
      throw error
  ...
  async getRepositoriesNpmHosted(name: string) {
    try {
      const res = await this.fetch(`/repositories/npm/hosted/${name}`)
      return res.data
    } catch (error) {
      if (error instanceof NexusError && error.status === 404) return null
      throw error
  ...
  @StartActiveSpan()
  async getRepositoriesNpmGroup(name: string) {
    try {
      const res = await this.fetch(`/repositories/npm/group/${name}`)
      return res.data
    } catch (error) {
      if (error instanceof NexusError && error.status === 404) return null
      throw error
  ...
  @StartActiveSpan()
  async getSecurityPrivileges(name: string) {
    try {
      const res = await this.fetch(`/security/privileges/${name}`)
      return res.data
    } catch (error) {
      if (error instanceof NexusError && error.status === 404) return null
      throw error
  ...
  @StartActiveSpan()
  async getSecurityRoles(id: string) {
    try {
      const res = await this.fetch(`/security/roles/${id}`)
      return res.data
    } catch (error) {
      if (error instanceof NexusError && error.status === 404) return null
      throw error
