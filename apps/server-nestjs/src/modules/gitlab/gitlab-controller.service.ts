...
import { StartSpan, ActiveSpan } from '@/cpin-module/infrastructure/telemetry/telemetry.decorator'
...
export class GitlabControllerService {
  ...
  async handleUpsert(@ActiveSpan() span: Span, project: ProjectWithDetails) {
