...
import { GitlabService, GitlabClientService } from './gitlab.service'
...
const gitlabMock = mockDeep<Gitlab>()
...
describe('gitlabService', () => {
  let service: Mocked<GitlabService>
  ...
  describe('createEmptyProjectRepository', () => {
    it('should create repository and first commit', async () => {
      ...
      gitlabMock.Groups.show.mockResolvedValueOnce({ id: 123, full_path: 'forge/console' })
      gitlabMock.Groups.all.mockResolvedValueOnce({
