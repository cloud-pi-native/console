...
import type { AccessTokenScopes, CommitAction, GroupSchema, PipelineTriggerTokenSchema } from '@gitbeaker/core'
...
export class GitlabService {
  ...
  async getUserByEmail(email: string) {
    const users = await this.client.Users.all({ search: email })
