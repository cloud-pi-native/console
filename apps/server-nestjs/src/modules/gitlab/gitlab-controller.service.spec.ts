...
import { GitlabDatastoreService, ProjectWithDetails } from './gitlab-datastore.service'
import { VaultService } from '../vault/vault.service'
import { ConfigurationService } from '@/cpin-module/infrastructure/configuration/configuration.service'
import { vi, describe, beforeEach, it, expect, type Mocked } from 'vitest'
import { AccessTokenExposedSchema, GroupSchema, ProjectSchema, SimpleUserSchema } from '@gitbeaker/core'
    ...
    providers: [
      GitlabControllerService,
      {
        ...
        useValue: {
          ...
          updateProject: vi.fn(),
        } satisfies Mocked<Partial<GitlabService>>,
      },
      {
        provide: GitlabDatastoreService,
        useValue: {
          getAllProjects: vi.fn(),
        } satisfies Mocked<Partial<GitlabDatastoreService>>,
      },
      {
        ...
        useValue: {
          ...
          write: vi.fn(),
          destroy: vi.fn(),
        } satisfies Mocked<Partial<VaultService>>,
      },
      {
