...
import type { AccessTokenExposedSchema, SimpleUserSchema } from '@gitbeaker/core'
import { AccessLevel } from '@gitbeaker/core'
import { faker } from '@faker-js/faker'
import { notFoundError, makeProjectWithDetails, makeGroupSchema, makeProjectSchema, makePipelineTriggerToken, makeSimpleUserSchema, makeMemberSchema, makeExpandedUserSchema } from './gitlab-testing.utils'
...
describe('gitlabControllerService', () => {
  ...
  beforeEach(async () => {
    ...
    vault.writeMirrorCreds.mockResolvedValue(undefined)
    vault.writeMirrorTriggerToken.mockResolvedValue(undefined)
    vault.readMirrorCreds.mockRejectedValue(notFoundError('GET', '/v1/kv/data/forge/project-1/tech/GITLAB_MIRROR'))
    vault.readGitlabMirrorCreds.mockRejectedValue(notFoundError('GET', '/v1/kv/data/forge/project-1/repo-1-mirror'))
  })
