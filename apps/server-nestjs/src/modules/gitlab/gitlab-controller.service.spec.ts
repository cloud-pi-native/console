...
describe('gitlabControllerService', () => {
  ...
  describe('handleUpsert', () => {
    ...
    it('should remove orphan member if purge enabled', async () => {
      config.gitlabControllerPurgeOrphanMembers = true
      const project = {
        id: 'p1',
        slug: 'project-1',
        name: 'Project 1',
    ...
    it('should not remove orphan member if purge disabled', async () => {
      config.gitlabControllerPurgeOrphanMembers = false
      const project = {
        id: 'p1',
        slug: 'project-1',
        name: 'Project 1',
  ...
  describe('handleCron', () => {
    it('should reconcile all projects', async () => {
      const projects = [{ id: 'p1', slug: 'project-1', members: [], repositories: [], clusters: [] }] as unknown as ProjectWithDetails[]
      // @ts-ignore
