...
export class KeycloakControllerService implements OnModuleInit {
  ...
  constructor(
    ...
    console.log('KeycloakControllerService constructor', {
      keycloakService: !!this.keycloakService,
      keycloakDatastore: !!this.keycloakDatastore,
  ...
  private async reconcile() {
    ...
    try {
      console.log('calling keycloakDatastore.getAllProjects')
