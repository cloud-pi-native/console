...
describe('keycloakReconcilerService', () => {
  ...
  const mockConfigService = {
    keycloakReconcilerPurgeOrphans: false,
  }
  ...
  describe('reconcile', () => {
    ...
    it('should reconcile projects and purge orphans if enabled', async () => {
      // Setup
      configService.keycloakReconcilerPurgeOrphans = true
    ...
    it('should not purge orphans if disabled', async () => {
      // Setup
      configService.keycloakReconcilerPurgeOrphans = false
      mockPrismaService.project.findMany.mockResolvedValue([mockProject])
    ...
    it('should sync OIDC role groups correctly', async () => {
      ...
      mockPrismaService.project.findMany.mockResolvedValue([projectWithRole])
