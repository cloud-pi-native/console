...
describe('keycloakControllerService', () => {
  ...
  describe('reconcile', () => {
    ...
    it('should sync environment groups', async () => {
      ...
      mockKeycloakService.getOrCreateConsoleGroup.mockResolvedValue({ id: 'console-id', name: 'console' })
      mockKeycloakService.getOrCreateEnvironmentGroups.mockResolvedValue({
