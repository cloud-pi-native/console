...
describe('keycloakControllerService', () => {
  ...
  describe('reconcile', () => {
    ...
    it('should purge orphans if enabled', async () => {
      ...
      mockKeycloakService.getOrCreateSubGroupByName.mockResolvedValue({ id: 'console-id', name: 'console' })
    ...
    it('should sync environment groups', async () => {
      ...
      mockKeycloakService.getOrCreateSubGroupByName.mockImplementation((_parentId, name) => {
      ...
      expect(keycloakService.getOrCreateSubGroupByName).toHaveBeenCalledWith('console-id', 'dev')
      // Should create RO/RW groups
      expect(keycloakService.getOrCreateSubGroupByName).toHaveBeenCalledWith('dev-id', 'RO')
      expect(keycloakService.getOrCreateSubGroupByName).toHaveBeenCalledWith('dev-id', 'RW')
