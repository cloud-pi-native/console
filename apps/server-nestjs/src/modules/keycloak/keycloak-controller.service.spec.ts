...
describe('keycloakReconcilerService', () => {
  ...
  let keycloakDatastore: KeycloakDatastoreService
  ...
  beforeEach(async () => {
    service = new KeycloakControllerService(
      mockKeycloakService as any,
      mockKeycloakDatastore as any,
      mockConfigService as any,
    )
    keycloakService = mockKeycloakService as any
    keycloakDatastore = mockKeycloakDatastore as any
