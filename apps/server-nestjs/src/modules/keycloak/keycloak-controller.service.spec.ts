  ...
  return Test.createTestingModule({
    providers: [
      ...
      },
      {
        ...
        useValue: {
          keycloakControllerPurgeOrphanGroups: false,
          keycloakControllerPurgeOrphanMembers: false,
...
describe('keycloakControllerService', () => {
  ...
  let config: Mocked<ConfigurationService>
  ...
  describe('reconcile', () => {
    ...
    it('should purge orphans if enabled', async () => {
      // Setup
      config.keycloakControllerPurgeOrphanGroups = true
    ...
    it('should not purge orphans if disabled', async () => {
      // Setup
      config.keycloakControllerPurgeOrphanGroups = false
      keycloakDatastore.getAllProjects.mockResolvedValue([mockProject])
      ...
      expect(keycloak.deleteGroup).not.toHaveBeenCalled()
    })

    it('should sync project members', async () => {
      // Setup
      config.keycloakControllerPurgeOrphanMembers = true
