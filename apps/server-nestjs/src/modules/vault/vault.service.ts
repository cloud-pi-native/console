...
export class VaultService {
  ...
  @StartActiveSpan('readProjectValues')
  ...
  @StartActiveSpan('readGitlabMirrorCreds')
  ...
  @StartActiveSpan('writeGitlabMirrorCreds')
  ...
  @StartActiveSpan('deleteGitlabMirrorCreds')
  ...
  @StartActiveSpan('readTechnReadOnlyCreds')
  ...
  @StartActiveSpan('writeTechnReadOnlyCreds')
  ...
  @StartActiveSpan('writeMirrorTriggerToken')
  ...
  @StartActiveSpan('destroyProjectSecrets')
