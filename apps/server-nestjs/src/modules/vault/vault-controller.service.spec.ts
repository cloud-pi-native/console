  ...
  return Test.createTestingModule({
    providers: [
      ...
      },
      {
        ...
        useValue: {
          upsertProject: vi.fn().mockResolvedValue({ data: undefined, error: null }),
          upsertZone: vi.fn().mockResolvedValue({ data: undefined, error: null }),
          deleteProject: vi.fn().mockResolvedValue({ data: undefined, error: null }),
          destroyProjectSecrets: vi.fn().mockResolvedValue({ data: undefined, error: null }),
