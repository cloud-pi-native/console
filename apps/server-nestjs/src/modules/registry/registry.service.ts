...
export class RegistryService {
  ...
  private async ensureProjectGroupMembers(project: ProjectWithDetails) {
    ...
    const groupAccessLevelByName = await this.generateAccessLebelMapping(project)
    for (const [groupName, accessLevel] of groupAccessLevelByName.entries()) {
  ...
  private async generateAccessLebelMapping(project: ProjectWithDetails) {
    const [
