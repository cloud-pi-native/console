...
import { AuthService } from '../src/cpin-module/infrastructure/iam/auth.service'
...
describeWithSystemSettings('systemSettingsController (e2e)', () => {
  ...
  beforeAll(async () => {
    const moduleRef = await Test.createTestingModule({
      ...
      providers: [AuthService, ConfigurationService, JwtService, { provide: CACHE_MANAGER, useValue: Cache }],
    }).compile()
