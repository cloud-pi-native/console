...
import { projectSelect } from '../src/modules/plugins/argocd/argocd-datastore.service'
import { ArgoCDModule } from '../src/modules/plugins/argocd/argocd.module'
import { ArgoCDService } from '../src/modules/plugins/argocd/argocd.service'
import { GITLAB_REST_CLIENT, GitlabClientService } from '../src/modules/plugins/gitlab/gitlab-client.service'
...
describeWithArgoCD('ArgoCDController (e2e)', {}, () => {
  ...
  beforeAll(async () => {
    ...
    infraRepoPath = `${config.projectRootDir}/infra/${zoneSlug}`
    try {
    ...
    vaultProjectValuesPath = `${config.projectRootDir}/${testProjectId}`
