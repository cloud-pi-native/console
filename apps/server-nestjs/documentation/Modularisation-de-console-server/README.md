...
5. **MODULARISATION-STATUT.md** - Suivi en temps réel de l'avancement
   ...
   - État du routage nginx (routes basculées)
   - Zones en "feature freeze"
   - Dates clés

6. **MODULARISATION-CARTOGRAPHIE.md** - Cartographie des modules
   - Liste de tous les modules avec métadonnées et statut (routé / exposé / encapsulé)
...
*Version 1.1 - Dernière mise à jour : 2026-07-16 (réconciliation avec l'état du code)*
