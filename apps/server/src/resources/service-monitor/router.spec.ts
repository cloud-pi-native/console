...
describe('test serviceContract', () => {
  ...
  it('should return complete services, with cause', async () => {
    ...
    const response = await app.inject().get(serviceContract.getCompleteServiceHealth.path).end();
  ...
  it('should return services', async () => {
    businessCheckMock.mockReturnValue(servicesComplete);
    const response = await app.inject().get(serviceContract.getServiceHealth.path).end();
