...
describe('test stageContract', () => {
  ...
  describe('listStages', () => {
    it('should return list of stages', async () => {
      ...
      const response = await app.inject().get(stageContract.listStages.path).end();
  ...
  describe('createStage', () => {
    ...
    it('should create and return stage for admin', async () => {
      ...
      const response = await app.inject().post(stageContract.createStage.path).body(stage).end();
