...
import type { DeleteEnvironmentExecArgs, Environment, InitializeEnvironmentExecArgs, Organization, Project, ResourceQuota, UpdateEnvironmentQuotaExecArgs } from '@/plugins/hooks/index.js'
import { createResourceQuota, findResourceQuota, replaceResourceQuota } from './quota.js'
import { createHmac } from 'node:crypto'

// Plugins Functions
export const createKubeNamespace: StepCall<InitializeEnvironmentExecArgs> = async (payload) => {
  try {
...
export const updateResourceQuota: StepCall<UpdateEnvironmentQuotaExecArgs> = async (payload) => {
  try {
...
export const deleteKubeNamespace: StepCall<DeleteEnvironmentExecArgs> = async (payload) => {
  try {
