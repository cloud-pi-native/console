...
export const getServices = (project) => {
  project.services = [{
    ...
    to: `${gitlabUrl}/forge-mi/projects/${project.organization.name}/${project.name}`,
  },
  {
    id: 'vault',
    title: 'Vault',
    ...
    to: `${vaultUrl}/ui/vault/secrets/forge-dso/list/forge-mi/projects/${project.organization.name}/${project.name}`,
  },
  {
    id: 'sonarqube',
    title: 'SonarQube',
    ...
    to: `${sonarqubeUrl}/dashboard?id=${project.organization.name}-${project.name}`,
  },
  {
    id: 'nexus',
    title: 'Nexus',
    ...
    to: `${nexusUrl}/#browse/browse:${project.organization.name}-${project.name}-repository-group`,
  },
  {
    id: 'quay',
    title: 'Quay',
    ...
    to: `${quayUrl}/organization/${project.organization.name}-${project.name}`,
  },
  {
    id: 'argocd',
    title: 'ArgoCD',
    ...
    to: `${argocdUrl}/applications?showFavorites=false&proj=&sync=&health=&namespace=&cluster=&labels=&search=${project.organization.name}-${project.name}`,
  }]
