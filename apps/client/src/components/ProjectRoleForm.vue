...
import { isSystemRoleType, PROJECT_PERMS, projectPermsDetails, shallowEqual } from '@cpn-console/shared'
...
if (!isSystemRoleType(role.value.type)) role.value.type = 'managed'

const isManaged = computed(() => !isSystem.value)
