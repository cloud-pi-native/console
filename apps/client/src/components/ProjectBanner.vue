...
const classStatusMapper: Record<Project['status'], string> = {
  archived: '',
  created: '',
  failed: 'fr-callout--yellow-tournesol',
  warning: 'fr-callout--yellow-tournesol',
  initializing: 'fr-callout--yellow-tournesol',
  ...
  >
    ...
    >
      <div class="flex flex-row items-center gap-3">
        ...
        <div :class="`flex flex-row gap-2 ${classStatusMapper[project.status]}`">
          <DsoBadge
            class="inline"
            :resource="{
              ...project,
