...
const isReplaying = computed(() => !!props.project.operationsInProgress.find(ope => ope.startsWith('update')))
...
<template>
  <DsfrButton
    ...
    :icon="{ name: 'ri:refresh-line', animation: isReplaying ? 'spin' : undefined }"
