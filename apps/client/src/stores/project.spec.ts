...
describe('project Store', () => {
  ...
  it("should retrieve user's projects by api call", async () => {
    ...
    listProjects.mockReturnValueOnce(Promise.resolve({ status: 200, body: projects, headers: {} }));
    listEnvironments.mockReturnValue(
      Promise.resolve({ status: 200, body: randomDbSetup.project.environments, headers: {} }),
    );
    listRepositories.mockReturnValue(
      Promise.resolve({ status: 200, body: randomDbSetup.project.repositories, headers: {} }),
    );
  ...
  it('should create a project by api call', async () => {
    ...
    apiClientPost.mockReturnValueOnce(
      Promise.resolve({ status: 201, body: newProject, headers: {} }),
    );
    listProjects.mockReturnValueOnce(
      Promise.resolve({ status: 200, body: [...projects, newProject], headers: {} }),
    );
