...
describe('Dashboard', () => {
  ...
  it('Should add, display and edit description', () => {
    ...
    cy.kcLogin('test')
      .goToProjects()
      .getByDataTestid(`projectTile-${projectToKeep.name}`)
      .click()
      .getByDataTestid('menuDashboard')
      .click()
    cy.wait('@listStages')
      .getByDataTestid('setDescriptionBtn')
      .click()
      .getByDataTestid('descriptionInput')
      .clear()
      .type(description1)
      .getByDataTestid('saveDescriptionBtn')
      .click()
      .wait('@updateProject')
      .its('response.statusCode')
      .should('match', /^20\d$/)
      .getByDataTestid('descriptionP')
  ...
  it('Should show project secrets', () => {
    ...
    cy.goToProjects()
      .getByDataTestid(`projectTile-${projectCreated.name}`)
      .click()
      .getByDataTestid('menuDashboard')
      .click()
    ...
    cy.wait('@listStages')
      .getByDataTestid('projectSecretsZone')
      .should('not.exist')
      .getByDataTestid('showSecretsBtn')
      .click()
