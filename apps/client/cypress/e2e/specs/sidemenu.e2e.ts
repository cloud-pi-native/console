...
describe('Sidemenu', () => {
  it('Should display Sidemenu, not loggedIn', () => {
    cy.visit('/')
      ...
      .should('be.visible')
      .getByDataTestid('menuAdministrationList')
      .should('not.exist')
  ...
  it('Should display Sidemenu, loggedIn, isNotAdmin', () => {
    ...
    cy.visit('/')
      ...
      .getByDataTestid('menuProjectsList')
      .should('be.visible')
      .getByDataTestid('menuMyProjects')
      .click()
      .url()
      ...
      .getByDataTestid('menuServices')
      .click()
      .getByDataTestid('menuProjectsList')
      .should('be.visible')
      .url()
      .should('contain', `/projects/${project.id}/services`)
      ...
      .should('be.visible')
      .url()
      .should('contain', `/projects/${project.id}/repositories`)
      .getByDataTestid('menuEnvironments')
      .click()
      .getByDataTestid('menuProjectsList')
      .should('be.visible')
      .url()
      .should('contain', `/projects/${project.id}/environments`)
      .getByDataTestid('menuDoc')
      .should('be.visible')
  })
  ...
  it('Should display Sidemenu, loggedIn, isAdmin', () => {
    ...
    cy.visit('/')
      ...
      .getByDataTestid('menuAdministrationOrganizations')
      .click()
      .getByDataTestid('menuAdministrationOrganizations')
      .should('have.class', 'router-link-active')
      .getByDataTestid('menuAdministrationUsers')
      ...
      .should('not.be.visible')
      .url()
      .should('contain', '/admin/organizations')
  })
})
