...
import { createRepositoryOnProject, synchronizeBranchOnRepository } from '../helpers/repository'
...
test.describe('Projects page', () => {
  ...
  test(
    ...
    async ({ page }) => {
      ...
      const firstRepositoryName = await createRepositoryOnProject({ page })
      const branchName = await synchronizeBranchOnRepository({
        page,
        repositoryName: firstRepositoryName,
      })
      const secondRepositoryName = await createRepositoryOnProject({ page })
