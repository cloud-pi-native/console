...
@Module({
  imports: [DatabaseModule, ConditionalModule.registerWhen(GitlabModule, 'USE_GITLAB'), TerminusModule, VaultModule, ConfigModule.forFeature(argocdConfigFactory), ConfigModule.forFeature(vaultConfigFactory), ConfigModule.forFeature(baseConfigFactory)],
