...
Ces charts Helm ont pour vocation le pilotage des déploiements ArgoCD "en cascade" tout en évitant à la console de connaitre la CRD de chacun de ces objets.
...
```sh
helm template --dry-run ./dso-app -f dso-app/example-values.yaml
```
