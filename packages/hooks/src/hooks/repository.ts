...
export type CreateRepositoryValidateArgs = Record<string, never>
export type CreateRepositoryExecArgs = RepositoryCreate
export type UpdateRepositoryValidateArgs = Record<string, never>
export type UpdateRepositoryExecArgs = RepositoryUpdate
export type DeleteRepositoryValidateArgs = Record<string, never>
