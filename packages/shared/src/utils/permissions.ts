...
export const ProjectAuthorized = {
  ...
  ListMembers: (perms: ProjectAuthorizedParams) => AdminAuthorized.Manage(perms.adminPermissions)
    || !!(toBigInt(perms.projectPermissions) & (PROJECT_PERMS.LIST_MEMBERS | PROJECT_PERMS.MANAGE_MEMBERS | PROJECT_PERMS.MANAGE)),
  ListRoles: (perms: ProjectAuthorizedParams) => AdminAuthorized.Manage(perms.adminPermissions)
