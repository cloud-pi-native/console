...
export const ProjectAuthorized = {
  ...
  ListEnvironments: (perms: ProjectAuthorizedParams) => AdminAuthorized.ManageProjects(perms.adminPermissions)
    || !!(toBigInt(perms.projectPermissions) & (PROJECT_PERMS.LIST_ENVIRONMENTS | PROJECT_PERMS.MANAGE_ENVIRONMENTS | PROJECT_PERMS.MANAGE)),
  ListRepositories: (perms: ProjectAuthorizedParams) => AdminAuthorized.ManageProjects(perms.adminPermissions)
