...
export const TokenSchema = z.object({
  ...
  name: z
    ...
    .regex(/^[a-z0-9][a-z0-9-]*[a-z0-9]$/, {
      message:
        'Le nom ne peut être constitué que de caractères minuscules, de chiffres et de tirets (-)',
    }),
  lastUse: dateToString.nullable(),
  createdAt: dateToString,
  owner: UserSchema.pick({ email: true, firstName: true, lastName: true, id: true, type: true })
    .optional()
    .nullable(),
