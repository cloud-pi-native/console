      ...
      responses: {
        200: z.array(
          z.object({
            ...
            cpu: EnvironmentSchema.shape.cpu,
            gpu: EnvironmentSchema.shape.gpu,
            memory: EnvironmentSchema.shape.memory,
          }),
        ),
        401: ErrorSchema,
        404: ErrorSchema,
...
export type ClusterAssociatedEnvironments = ClientInferResponseBody<
  typeof clusterContract.getClusterEnvironments,
  200
>;
