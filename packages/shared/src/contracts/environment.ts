...
import { EnvironmentSchema } from '../schemas/index.js';
...
export const environmentContract = contractInstance.router(
  {
    ...
    listEnvironments: {
      ...
      responses: {
        200: EnvironmentSchema.omit({ name: true }).extend({ name: z.string() }).array(),
        400: ErrorSchema,
        401: ErrorSchema,
        403: ErrorSchema,
        404: ErrorSchema,
...
export type CreateEnvironmentBody = ClientInferRequest<
  typeof environmentContract.createEnvironment
>['body'];
export type UpdateEnvironmentBody = ClientInferRequest<
  typeof environmentContract.updateEnvironment
>['body'];
