    ...
    data: {
      ...
      roles: {
        create: [
          ...
          {
            name: 'Développeur',
            permissions: PROJECT_PERMS.MANAGE_REPOSITORIES | PROJECT_PERMS.REPLAY_HOOKS | PROJECT_PERMS.SEE_SECRETS | PROJECT_PERMS.LIST_ENVIRONMENTS | PROJECT_PERMS.LIST_REPOSITORIES,
            position: 2,
          ...
          },
          {
            ...
            position: 3,
            oidcGroup: `/${params.slug}/console/security`,
            type: 'system:managed',
          },
          {
            name: 'Lecture seule',
