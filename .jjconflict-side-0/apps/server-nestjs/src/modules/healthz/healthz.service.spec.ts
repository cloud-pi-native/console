...
describe('healthzService', () => {
  ...
  describe('with all optional probes registered', () => {
    ...
    let opencds: ReturnType<typeof mockDeep<OpenCdsHealthService>>
    ...
    beforeEach(async () => {
      ...
      opencds = mockDeep<OpenCdsHealthService>()
      const moduleRef = await Test.createTestingModule({
        ...
        providers: [
          ...
          { provide: OpenCdsHealthService, useValue: opencds },
        ],
      }).compile()
  ...
  describe('without optional probes registered (@Optional -> undefined)', () => {
    let healthCheck: ReturnType<typeof mockDeep<HealthCheckService>>
    let database: ReturnType<typeof mockDeep<DatabaseHealthService>>
    let service: HealthzService
