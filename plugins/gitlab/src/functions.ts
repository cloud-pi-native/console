...
export const upsertProjectMember: StepCall<ProjectMember> = async (payload) => {
  ...
  const projectReporterGroupPathSuffix = config?.projectReporterGroupPathSuffix
  if (!projectReporterGroupPathSuffix) {
    throw new Error('projectReporterGroupPathSuffix is required')
  }
  const projectDeveloperGroupPathSuffix = config?.projectDeveloperGroupPathSuffix
  if (!projectDeveloperGroupPathSuffix) {
    throw new Error('projectDeveloperGroupPathSuffix is required')
  }
  const projectMaintainerGroupPathSuffix = config?.projectMaintainerGroupPathSuffix
  if (!projectMaintainerGroupPathSuffix) {
    throw new Error('projectMaintainerGroupPathSuffix is required')
  }
