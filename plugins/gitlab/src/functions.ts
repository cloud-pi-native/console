...
export const upsertAdminRole: StepCall<AdminRole> = async (payload) => {
  try {
    ...
    const auditorGroupPath = payload.config.gitlab?.auditorGroupPath ?? '/console/auditor'
...
export const upsertProjectMember: StepCall<ProjectMember> = async (payload) => {
  ...
  const purge = payload.config.gitlab?.purge ?? DISABLED
  const projectReporterGroupPathSuffix = payload.config.gitlab?.projectReporterGroupPathSuffix ?? '/console/readonly'
  const projectDeveloperGroupPathSuffix = payload.config.gitlab?.projectDeveloperGroupPathSuffix ?? '/console/developer'
  const projectMaintainerGroupPathSuffix = payload.config.gitlab?.projectMaintainerGroupPathSuffix ?? '/console/admin'
