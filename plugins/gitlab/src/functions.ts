...
export const upsertAdminRole: StepCall<AdminRole> = async (payload) => {
  try {
    ...
    const isAdmin = role.oidcGroup === '/admin' ? true : undefined
    const isAuditor = role.oidcGroup === '/readonly' ? true : undefined
...
export const deleteAdminRole: StepCall<AdminRole> = async (payload) => {
  try {
    ...
    const isAdmin = role.oidcGroup === '/admin' ? false : undefined
    const isAuditor = role.oidcGroup === '/readonly' ? false : undefined
