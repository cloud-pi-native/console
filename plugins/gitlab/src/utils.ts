...
export function matchRole(projectSlug: string, roleOidcGroup: string | undefined, configuredRolePath: string | undefined) {
  if (!roleOidcGroup || !configuredRolePath) return false
